...
from flask_login import login_manager, LoginManager, login_user, logout_user, login_required, current_user, UserMixin
...
def forge():
    ...
    user = User(name=name,username=name,password_hash='123')
